...
export default function LoginPage() {
  ...
  const { loginWithCredentials } = useModesy();
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 bg-[#f8f9fa]">
      {/* Modal Dialog Styled Card matching Screenshot 1 */}
      <div className="relative w-full max-w-[390px] rounded-[6px] bg-white p-7 shadow-[0_10px_25px_rgba(0,0,0,0.08)] border border-[#eef0f3]">
        {/* Close Button Top Right (Links back to home) */}
        <Link
          href="/"
        ...
        {/* Title */}
        <h2 className="text-[26px] font-bold text-[#203145] text-center mb-6">Login</h2>
